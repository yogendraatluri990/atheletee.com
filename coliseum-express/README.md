...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/vO8IaR4q3c)
...
```sh
npx nx serve atheletee
```

To create a production bundle:

```sh
npx nx build atheletee
```

To see all available targets to run for a project, run:

```sh
npx nx show project atheletee
```
